...
def test_load_rootfs_manifest_from_json_sample():
    ...
    assert manifest.version == "bookworm-slim-2026-05-gui-gpu-v35"
    assert manifest.assets[0].path == "tiny-rootfs.tar"
    assert manifest.assets[0].sha256 == "7adc9444061df78e9966570bbf49e5df161275389979015542774d6db8f17796"
    assert manifest.assets[0].size_bytes == 252743680

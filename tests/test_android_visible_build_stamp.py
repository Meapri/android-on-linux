...
def test_debug_apk_version_code_is_bumped_for_device_update():
    ...
    assert "versionCode = 131" in text
    assert 'versionName = "0.4.131-cp5-gpu-throughput-v131"' in text
...
def test_main_activity_starts_with_visible_build_stamp_before_summary():
    ...
    assert text.index("build: 0.4.131-cp5-gpu-throughput-v131") < text.index("execution summary")

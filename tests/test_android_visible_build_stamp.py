...
def test_debug_apk_version_code_is_bumped_for_device_update():
    ...
    assert "versionCode = 121" in text
    assert 'versionName = "0.4.121-chromium-runs-inprocess-v121"' in text
...
def test_main_activity_starts_with_visible_build_stamp_before_summary():
    ...
    assert text.index("build: 0.4.121-chromium-runs-inprocess-v121") < text.index("execution summary")

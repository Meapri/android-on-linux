...
def test_debug_apk_version_code_is_bumped_for_device_update():
    ...
    assert "versionCode = 113" in text
    assert 'versionName = "0.4.113-android-gimp-ahb-zerocopy-v113"' in text
...
def test_main_activity_starts_with_visible_build_stamp_before_summary():
    ...
    assert text.index("build: 0.4.113-android-gimp-ahb-zerocopy-v113") < text.index("execution summary")

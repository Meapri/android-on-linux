...
| GUI 앱 (7종 toolkit) | **GIMP 3.0.2** 풀 렌더(터치), gtk3-widget-factory, gtk3-demo(2213 프레임), foot 터미널, **netsurf-gtk 웹브라우저**(5 threads), **SDL2 창**(testdraw2), **Qt6 위젯**(analogclock, wl_shm) — 전부 rendered=true | [drain#9](evidence/2026-06-02-5ws-fanout-renderer-getpwuid-pkgfunc.md), [netsurf](evidence/2026-06-02-netsurf-browser-renders.md), [Qt6](evidence/2026-06-02-round6-qt6-execreentry-vkrender.md) |

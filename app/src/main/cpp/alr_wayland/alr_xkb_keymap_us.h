...
//   xkbcli compile-keymap --layout us --model pc105
//   (libxkbcommon 1.13.2 / xkeyboard-config 2.47)
//
// Fully expanded (NO include directives) so a guest client compiles it via
// xkb_keymap_new_from_string WITHOUT any /usr/share/X11/xkb data in the rootfs.
// The compositor sends this as WL_KEYBOARD_KEYMAP_FORMAT_XKB_V1 (see
// seat_get_keyboard in alr_compositor.cpp), replacing the old NO_KEYMAP that
// forced the client to self-build from missing rootfs xkb files -> NULL -> SEGV.
#ifndef ALR_WAYLAND_ALR_XKB_KEYMAP_US_H
#define ALR_WAYLAND_ALR_XKB_KEYMAP_US_H
namespace alr::wayland {
inline constexpr char kUsXkbKeymapV1[] =
R"XKBKEYMAP(
xkb_keymap {
...
#endif  // ALR_WAYLAND_ALR_XKB_KEYMAP_US_H
